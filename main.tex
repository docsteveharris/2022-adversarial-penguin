...
\def\Authors{Steve Harris\,$^{1,2*}$, Tim Bonnici\,$^{1,2}$ Thomas Keen\,$^{1}$ Watjana Lilaonitkul\,$^{1}$ Nel Swanepoel\,$^{3}$ Mark White\,$^{4}$}
